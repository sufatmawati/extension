...
import { Sip010TokenAssetList } from './stacks/sip010-token-asset-list/sip010-token-asset-list';
import { Sip010TokenAssetListUnsupported } from './stacks/sip010-token-asset-list/sip010-token-asset-list-unsupported';
  ...
  return (
    <Stack>
      {whenWallet({
        ...
        ledger: (
          <BitcoinNativeSegwitAccountLoader current fallback={<BtcCryptoAssetItemFallback />}>
            {nativeSegwitAccount => (
              <BtcCryptoAssetLoader address={nativeSegwitAccount.address}>
                {(asset, isInitialLoading) => (
                  <BtcCryptoAssetItem
      ...
      <CurrentStacksAccountLoader fallback={<StxCryptoAssetItemFallback />}>
        {account => (
          <>
            ...
            <Sip010TokenAssetList address={account.address} onClick={onClick} />
            {isReadOnly && (
      ...
      {isReadOnly && (
        <CurrentStacksAccountLoader>
          {account => <Sip010TokenAssetListUnsupported address={account.address} />}
        </CurrentStacksAccountLoader>
      )}
    </Stack>
  );

...
export function ChooseAccountsList() {
  ...
  // need to add accounts list unavailable here
  // test with:
  // new wallet
  // ledger
  // >> try get this ready ASAP and add some kind of better tests?
  // >> can I also simplify dialog code then? or is there a point
    ...
    <Box mt="space.05" mb="space.06" width="100%">
      ...
      <VirtuosoWrapper>
        <Virtuoso
          ...
          data={accounts} // not sure why data here? is that better for resize?
